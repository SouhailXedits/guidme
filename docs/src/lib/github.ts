...
export async function countStars(repo = "SouhailXedits/guidme"): Promise<number> {
  if (starCount) {
    return starCount;
  }
...
export async function getFormattedStars(repo = "SouhailXedits/guidme"): Promise<string> {
