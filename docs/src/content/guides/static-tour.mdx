...
<CodeSample
  ...
  tour={[
    ...
    { element: '.line:nth-child(4) span:nth-child(7)', popover: { title: 'Create Guidme', description: 'Simply call the guidme function to create a guidme instance', side: "left", align: 'start' }},
    ...
    { element: '.line:nth-child(6)', popover: { title: 'Hide Progress', description: 'Progress shown in the bottom left is hidden by default. You can make guidme show/hide the progress using this option.', side: "top", align: 'start' }},
...
>
  ...
  const guidme = guidme({
    ...
    steps: [
      ...
      { element: 'code .line:nth-child(4) span:nth-child(7)', popover: { title: 'Create Guidme', description: 'Simply call the guidme function to create a guidme instance', side: "left", align: 'start' }},
